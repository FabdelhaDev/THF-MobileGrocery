...
import { FlatList, Modal, Pressable, SafeAreaView, Text, TextInput, View, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function RecipesTab() {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      {!!item.description && (
        <Text style={{ marginTop: 4, opacity: 0.7 }}>{item.description}</Text>
      )}
            ...
            >
              ...
              >
                ...
                <Pressable
                  onPress={create}
                  disabled={!canCreate}
                  style={{ padding: 10, opacity: canCreate ? 1 : 0.4 }}
                >
